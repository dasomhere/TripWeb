...
<!-- 	</div> -->
	...
	<ul class="list-group">
		...
		<li class="list-group-item" data-ng-repeat="intro in localIntroDetail">체크카드
			사용 여 부: {{intro.chkcreditcard}}</li>
		<li class="list-group-item" data-ng-repeat="intro in localIntroDetail">애완동물
			출입가능여부: {{intro.chkpet}}</li>
		<li class="list-group-item" data-ng-repeat="intro in localIntroDetail"
