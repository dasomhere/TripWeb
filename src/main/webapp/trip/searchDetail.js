...
myApp.controller('searchDetailController', function($scope, $http, $routeParams) {
	...
	$http.get("/TripWeb/m/search/detailCommon?contentId=" + $routeParams.contentid).success(function(searchDetailCommon) {
		...
		$scope.mapinitialize($scope.searchDetailCommon[0].mapx, $scope.searchDetailCommon[0].mapy);
...
//	var globalMarker;
//	
//	$scope.mapinitialize = function(x, y) {
//		alert("xxx");
...
//		globalMap.setCenter(globalMap.getCenter()); 
//	};
//	
