	...
	<tabset justified="true"> 
		...
		<tab heading="기본정보">
			<div class="row">
				...
				<div class="col-sm-6">
					<ul>
						<li data-ng-hide="searchDetailCommon[0].zipcode == null"><b>우편번호 :</b> {{searchDetailCommon[0].zipcode}}</li>
						<li data-ng-hide="searchDetailCommon[0].telname == null"><b>전화명 : </b> {{searchDetailCommon[0].telname}}</li>
						<li data-ng-hide="searchDetailCommon[0].tel == null"><b>전화번호 : </b> {{searchDetailCommon[0].tel}}</li>
						<li data-ng-hide="searchDetailCommon[0].homepage == null"><b>홈페이지 :</b> <span data-ng-bind-html="searchDetailCommon[0].homepage"></span></li>
						<li data-ng-hide="searchDetailCommon[0].addr1 == null"><b>주소 : </b>{{searchDetailCommon[0].addr1}}</li>
					</ul>
				</div>
			</div>
		</tab>
		...
		<ul data-ng-if="searchDetailInfo[0].contenttypeid == 28 " data-ng-repeat="leports in searchDetailInfo">
			...
			<div class="row" data-ng-if="searchDetailInfo[0].contenttypeid == 32 " data-ng-repeat="stay in searchDetailInfo" style="margin-top: 10px">
				...
				<div align="center" style="margin-top: 10px">
				  <carousel> 
					<slide data-ng-if="stay.roomimg1 != null"> 
						<img  data-ng-src="{{stay.roomimg1}}" style="margin: auto; width: auto; height:auto; min-height: 200px; max-height: 400px;">
					</slide>
					<slide data-ng-if="stay.roomimg1 == null"> 
						<img  data-ng-src="http://placehold.it/150x100/808080/ffffff&text=No Image!" style="margin: auto; width: auto; height:auto; min-height: 200px; max-height: 400px;">
					</slide>  
					<slide data-ng-if="stay.roomimg2 != null"> 
						<img  data-ng-src="{{stay.roomimg2}}" style="margin: auto; width: auto; min-height: 200px; max-height: 400px;">
					</slide>
					<slide data-ng-if="stay.roomimg3 != null"> 
						<img  data-ng-src="{{stay.roomimg3}}" style="margin: auto; width: auto; min-height: 200px; max-height: 400px;">
					</slide>
					<slide  data-ng-if="stay.roomimg4 != null"> 
						<img data-ng-src="{{stay.roomimg4}}" style="margin: auto; width: auto; min-height: 200px; max-height: 400px;">
					</slide>
					<slide data-ng-if="stay.roomimg5 != null"> 
						<img  data-ng-src="{{stay.roomimg5}}" style="margin: auto; width: auto; min-height: 200px; max-height: 400px;">
					</slide>
				 </carousel>
				 </div>
			 </div>
