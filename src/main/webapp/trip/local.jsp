	...
	<div>
		<ul class="list-group">
		 	<li class="list-group-item" data-ng-repeat="type in localResult" data-ng-click=contentid(type.contentid)>
		 			<table>
		 			  <tr><td><img alt="" src="{{type.firstimage}}" style="width: 150px" height="150px"/><td><tr>
